...
NSString* const IsClearOldPkg = @"CLEAR_OLD_PKG";
...
+ (void)markDelOldPkg {
    NSUserDefaults* preferences = [NSUserDefaults standardUserDefaults];
    [preferences setBool:YES forKey:IsClearOldPkg];
    [preferences synchronize];
}

+ (BOOL)isDelOldPkg {
    NSUserDefaults* preferences = [NSUserDefaults standardUserDefaults];
    BOOL clearPkgFlagSet = [preferences boolForKey:IsClearOldPkg];
    return clearPkgFlagSet;
}

+ (void)clearIsDelOldPkg {
    NSUserDefaults *preferences = [NSUserDefaults standardUserDefaults];
    [preferences removeObjectForKey:IsClearOldPkg];
}
