...
public class CodePushPreferences {
    ...
    private static final String IS_CLEAR_OLD_PKG = "CLEAR_OLD_PKG";
    ...
    public void markDelOldPkg() {
        SharedPreferences preferences = context.getSharedPreferences(CodePushPreferences.IS_CLEAR_OLD_PKG, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = preferences.edit();
        editor.putBoolean(CodePushPreferences.IS_CLEAR_OLD_PKG, true);
        editor.commit();
    }

    public void clearIsDelOldPkg() {
        this.clearPreferences(CodePushPreferences.IS_CLEAR_OLD_PKG);
    }

    public boolean isDelOldPkg() {
        SharedPreferences preferences = context.getSharedPreferences(CodePushPreferences.IS_CLEAR_OLD_PKG, Context.MODE_PRIVATE);
        boolean isClearOldPkg = preferences.getBoolean(CodePushPreferences.IS_CLEAR_OLD_PKG, false);
        return isClearOldPkg;
    }
