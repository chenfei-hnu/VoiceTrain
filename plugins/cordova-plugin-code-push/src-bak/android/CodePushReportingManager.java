...
public class CodePushReportingManager {
    ...
    public void reportDebugInfo(String debugInfo, final CordovaWebView webView){
        final String script = String.format(
            Locale.US,
            "javascript:document.addEventListener(\"deviceready\", function () { window.codePush.reportDebugInfo(%s); });",
            convertStringParameter(debugInfo)
        );
